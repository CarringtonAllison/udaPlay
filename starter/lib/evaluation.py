...
class AgentEvaluator:
    ...
    def evaluate_final_response(self,
        ...
        try:
            ...
            evaluation = JudgeEvaluation(
                task_completed=len(agent_response.strip()) > 50,
                format_correct=len(agent_response.strip()) > 0,
                instructions_followed=len(agent_response.strip()) > 50,
    ...
    def evaluate_trajectory(self,
        ...
        has_final_response = any(isinstance(msg, AIMessage) and msg.content for msg in messages)
